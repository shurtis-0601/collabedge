...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes = [
    ...
    { path: '/campaigns/proptech-data-analytics', priority: 0.5, changeFrequency: 'monthly' as const },
    { path: '/campaigns/allied-health-data-analytics', priority: 0.5, changeFrequency: 'monthly' as const },
    { path: '/campaigns/retail-data-analytics', priority: 0.5, changeFrequency: 'monthly' as const },
