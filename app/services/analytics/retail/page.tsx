...
export const metadata: Metadata = {
  ...
  description:
    'For physical retailers, omnichannel operators and specialty independents wanting clear insight into sales performance, margin efficiency and supply chain risk.',
  openGraph: {
    title: 'Data Analytics for Retail | CollabEdge Solutions',
    description:
      'For physical retailers, omnichannel operators and specialty independents wanting clear insight into sales performance, margin efficiency and supply chain risk.',
