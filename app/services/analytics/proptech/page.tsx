...
export const metadata: Metadata = {
  ...
  description:
    'For property managers, mortgage brokers, builders and conveyancers wanting clear insight into portfolio risk, pipeline performance and compliance obligations.',
  openGraph: {
    title: 'Data Analytics for Proptech | CollabEdge Solutions',
    description:
      'For property managers, mortgage brokers, builders and conveyancers wanting clear insight into portfolio risk, pipeline performance and compliance obligations.',
