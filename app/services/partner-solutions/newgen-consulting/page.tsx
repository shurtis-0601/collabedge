...
export const metadata: Metadata = {
  ...
  description:
    'Newgen Consulting, a Zoho ecosystem specialist, working alongside CollabEdge Solutions for organisations that prefer a packaged software platform over a custom build. CollabEdge brings NDIS and healthcare domain expertise to the conversation.',
  openGraph: {
    title: 'Newgen Consulting | CollabEdge Solutions',
    description:
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-[14px] text-slate leading-relaxed max-w-[680px]">
                  CollabEdge and Newgen are working through what a joint engagement looks like in practice. For some organisations that may mean advisory input into how a Zoho deployment is configured, for others it may mean Newgen delivering the platform independently once the domain requirements are understood. If you are weighing a packaged platform against a custom build, the conversation is worth having either way.
                </p>
              </div>
            </div>
          </FadeIn>
