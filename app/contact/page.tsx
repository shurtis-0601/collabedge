      ...
      <section className="bg-white py-16 px-5 sm:px-10">
        <div className="max-w-[1000px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          ...
          <FadeIn variant="slideRight">
            ...
            <a
              href="/appt"
              className="inline-flex items-center gap-2 bg-gold text-navy font-bold text-[14px] px-6 py-3 rounded hover:bg-gold/90 hover:scale-[1.02] transition-all duration-200 w-full sm:w-auto justify-center sm:justify-start"
            >
              <Calendar size={15} />
            ...
            <div className="mt-8 pt-6 border-t border-border space-y-3">
              <p className="text-[14px] text-slate mb-3">Or reach us directly:</p>

              <a
                href="mailto:sinclair@collabedgesolutions.com.au"
                className="flex items-center gap-3 text-[14px] font-semibold text-navy hover:text-brand-goldLight transition-colors group"
              >
              ...
              <a
                href="tel:0426464442"
                className="flex items-center gap-3 text-[14px] text-slate hover:text-brand-goldLight transition-colors group"
              >
                <div className="w-8 h-8 rounded-full bg-gold/10 flex items-center justify-center group-hover:bg-gold/20 transition-colors flex-shrink-0">
              ...
              {steps.map((step, i) => (
                <FadeIn key={i} delay={i * 120} variant="fadeUp">
                  <div className="flex gap-4 items-start pb-5 mb-5 border-b border-border last:border-0 last:pb-0 last:mb-0">
                    <div className="w-7 h-7 rounded-full bg-gold flex items-center justify-center text-[14px] font-bold text-navy flex-shrink-0 mt-0.5">
                      {step.num}
                    </div>
                    <div>
                      <p className="text-[14px] font-semibold text-text-dark mb-1">{step.heading}</p>
          ...
          <FadeIn variant="slideRight">
            <div className="flex flex-col items-center md:items-start gap-4">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-[14px] text-brand-goldLight font-medium mt-0.5">Founder and Principal Consultant</p>
              </div>
