...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Privacy Policy for CollabEdge Solutions, ABN 38 557 169 242. How we collect, use and protect your personal information.',
    url: 'https://www.collabedgesolutions.com.au/privacy',
    ...
    <>
      ...
      <div className="bg-white py-16 px-6">
        <div className="max-w-[780px] mx-auto">
          ...
          <h2 className="text-[26px] font-bold text-text-dark mt-10 mb-3 tracking-tight">1. Who We Are</h2>
          <p className="text-[16px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[26px] font-bold text-text-dark mt-10 mb-3 tracking-tight">3. How We Collect Personal Information</h2>
          <p className="text-[16px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[26px] font-bold text-text-dark mt-10 mb-3 tracking-tight">4. How We Use Personal Information</h2>
          <p className="text-[16px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[26px] font-bold text-text-dark mt-10 mb-3 tracking-tight">5. Disclosure of Personal Information</h2>
          <p className="text-[16px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[26px] font-bold text-text-dark mt-10 mb-3 tracking-tight">6. MedPrivacy and De-identification</h2>
          <p className="text-[16px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[26px] font-bold text-text-dark mt-10 mb-3 tracking-tight">7. Data Security</h2>
          <p className="text-[16px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[26px] font-bold text-text-dark mt-10 mb-3 tracking-tight">8. Access and Correction</h2>
          <p className="text-[16px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[26px] font-bold text-text-dark mt-10 mb-3 tracking-tight">10. Website Analytics</h2>
          <p className="text-[16px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[26px] font-bold text-text-dark mt-10 mb-3 tracking-tight">11. Cookies</h2>
          <p className="text-[16px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[26px] font-bold text-text-dark mt-10 mb-3 tracking-tight">12. Links to Third-Party Sites</h2>
          <p className="text-[16px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[26px] font-bold text-text-dark mt-10 mb-3 tracking-tight">13. Changes to This Policy</h2>
          <p className="text-[16px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[26px] font-bold text-text-dark mt-10 mb-3 tracking-tight">14. Contact Us</h2>
          <p className="text-[16px] text-slate leading-relaxed mb-4">
