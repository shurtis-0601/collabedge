    ...
    <>
      ...
      <div className="bg-white py-16 px-6">
        <div className="max-w-[780px] mx-auto">
          ...
          <h2 className="text-[18px] font-bold text-text-dark mt-10 mb-3 tracking-tight">1. Use of This Website</h2>
          <p className="text-[14px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[18px] font-bold text-text-dark mt-10 mb-3 tracking-tight">2. Intellectual Property</h2>
          <p className="text-[14px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[18px] font-bold text-text-dark mt-10 mb-3 tracking-tight">3. Information Accuracy</h2>
          <p className="text-[14px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[18px] font-bold text-text-dark mt-10 mb-3 tracking-tight">4. Limitation of Liability</h2>
          <p className="text-[14px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[18px] font-bold text-text-dark mt-10 mb-3 tracking-tight">5. External Links</h2>
          <p className="text-[14px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[18px] font-bold text-text-dark mt-10 mb-3 tracking-tight">6. Service Engagements</h2>
          <p className="text-[14px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[18px] font-bold text-text-dark mt-10 mb-3 tracking-tight">7. Privacy</h2>
          <p className="text-[14px] text-slate leading-relaxed mb-4">
            Your use of this website is also governed by our Privacy Policy, available at{' '}
            <a href="/privacy" className="text-gold hover:underline">collabedgesolutions.com.au/privacy</a>.
          </p>

          <h2 className="text-[18px] font-bold text-text-dark mt-10 mb-3 tracking-tight">8. Governing Law</h2>
          <p className="text-[14px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[18px] font-bold text-text-dark mt-10 mb-3 tracking-tight">9. Changes to These Terms</h2>
          <p className="text-[14px] text-slate leading-relaxed mb-4">
          ...
          <h2 className="text-[18px] font-bold text-text-dark mt-10 mb-3 tracking-tight">10. Contact</h2>
          <p className="text-[14px] text-slate leading-relaxed mb-4">
