    ...
    <footer className="bg-navy-deep border-t border-white/5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-[14px] text-[#D1D5DB]">
              ...
              <li className="pl-3 text-[13px] text-[#9CA3AF]"><Link href="/services/analytics" className="hover:text-[#D1D5DB] transition-colors">Data Analytics for SMEs</Link></li>
      ...
      <div className="border-t border-white/5 py-5 text-center">
        <p className="text-[14px] text-[#9CA3AF]">
          © {new Date().getFullYear()} CollabEdge Solutions. All rights reserved. <span className="whitespace-nowrap">ABN 38 557 169 242.</span>
        </p>
      </div>
    </footer>
  );
